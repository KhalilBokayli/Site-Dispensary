...
<body style="background: -webkit-linear-gradient(left,  #5bc1ac ,  #5bc1ac); background-size: cover;">
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
    <div class="container">

      <!-- <a class="navbar-brand js-scroll-trigger" href="index.html" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp DISPENSARY</h4></a> -->
      ...
      <div class="col-md-7" style="padding-left: 180px; ">
        ...
        <div style="color: white;">
          <div class="icon-container">
            <img src="images/icons/login.png" alt="Icone">
            <style>
              .container {
                color: white;
                text-align: center;
              ...
              <form class="form-group" method="POST" action="func.php">
                ...
                <div class="row" style="margin-top: 10%;">
                  <div class="col-md-12 d-flex justify-content-between">
                    <input type="submit" id="inputbtn" name="patsub" value="Loginreg" class="btn btn-primary">
                    <input type="submit" id="inputbtn1" name="patsub1" value="Loginlab" class="btn btn-primary">
                  </div>
                </div>
