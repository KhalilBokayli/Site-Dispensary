...
<body style="padding-top:0px;">
    ...
    <div class="container-fluid" style="margin-top:50px;">
        ...
        <div class="row">
            <div class="col-md-4" style="max-width:18%;margin-top:-5% ;">
                <div class="gif-container">
                    <img src="images/icons/swipe-up.gif" alt="GIF" class="small-gif rotated-gif">
                </div>
                <div class="list-group" id="list-tab" role="tablist">
                    <a class="list-group-item list-group-item-action active" href="#list-dash" role="tab" style="background-color: #5bc1ac"
