...
<body style="padding-top:0px;">
  ...
  <div class="container-fluid" style="margin-top:50px;">
    <h3 style="margin-left: 40%; padding-bottom: 20px;font-family: 'IBM Plex Sans', sans-serif;"><strong>WELCOME RECEPTIONIST!</strong> </h3>
    <div class="row">
      ...
      <div class="col-md-4" style="max-width:25%;margin-top: 3%;">
        ...
        <div class="list-group" id="list-tab" role="tablist">
          ...
          <a class="list-group-item list-group-item-action" href="#list-lab" id="list-lab-list" role="tab" data-toggle="list" aria-controls="home">Appointment LAB</a>
                  ...
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      ...
                      <div class="icon-container1">
                        <img src="images/icons/medical-team.png" alt="Icone">
                        <style>
                          .icon-container {
                            text-align: center;
                            margin-top: 0px;
                ...
                <div class="col-sm-4" style="left: -3%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      <span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-users fa-stack-1x fa-inverse"></i> </span>
                      <div class="icon-container1">
                        <img src="images/icons/examination.png" alt="Icone">
                        <style>
                          .icon-container {
                            text-align: center;
                            margin-top: 0px;
                ...
                <div class="col-sm-4">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      ...
                      <p class="cl-effect-1">
                        <a href="#app-hist" onclick="clickDiv('#list-app-list')">reg app</a>
                        &nbsp|
                        <a href="#app-hist" onclick="clickDiv('#list-lab-list')">
                          lab app
                        </a>
                      </p>
                    </div>
                ...
                <div class="col-sm-4" style="left: 13%;margin-top: 5%;">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      ...
                      <div class="icon-container1">
                        <img src="images/icons/prescription.png" alt="Icone">
                        <style>
                          .icon-container {
                            text-align: center;
                            margin-top: 0px;
                ...
                <div class="col-sm-4" style="left: 18%;margin-top: 5%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      ...
                      <div class="icon-container1">
                        <img src="images/icons/-update.png" alt="Icone">
                        <style>
                          .icon-container {
                            text-align: center;
                            margin-top: 0px;
          ...
          <div class="tab-pane fade" id="list-lab" role="tabpanel" aria-labelledby="list-lab-list">
            ...
            <table class="table table-hover">
              ...
              <tbody>
                ...
                $query = "select * from appointmentlab;";
                $result = mysqli_query($con, $query);
                while ($row = mysqli_fetch_array($result)) {
                ?>
                  <tr>
